...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/F7IbK1prI0H6w5tJUXf2zB',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: './

',
    NEWSLETTER_JID: '120363399456492644@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94763513529',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbALrWd72WTxLzqqKG1y'
};

const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'NethminaPansil';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'testmini';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
...
`;
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                {
                                    title: 'MENU 📌',
                                    description: '𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 𝚅𝙾𝚁𝚃𝙴𝚇 𝙼𝙳',
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://files.catbox.moe/wh9ttz.jpg" },
        caption: `𝚅𝙾𝚁𝚃𝙴𝚇 𝙼𝙳 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
...
`;
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                ...
                                {
                                    title: 'OWNER NUMBER',
                                    description: '𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚅𝙾𝚁𝚃𝙴𝚇 𝙼𝙳',
                                    id: `${config.PREFIX}owner`,
                                },
                            ],
                        },
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://files.catbox.moe/jcx2qo.jpg" },
        caption: `𝚅𝙾𝚁𝚃𝙴𝚇 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃 𝐌𝙴𝙽𝚄\n\n${captionText}`,
    }, { quoted: msg });
    ...
    const ownerName = '𝙿𝚊𝚗𝚜𝚒𝚕𝚞 𝙽𝚎𝚝𝚑𝚖𝚒𝚗𝚊';
    const organization = '*𝕍𝕆ℝ𝕋𝔼𝕏 𝕄𝔻* WHATSAPP BOT DEVALOPER 🍬';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `*𝐕𝐎𝐑𝐓𝐄𝐗 𝐌𝐃 OWNER*\n\n👤 Name: ${ownerName}\n📞 Number: ${ownerNumber}\n\n> 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 𝐕𝐎𝐑𝐓𝐄𝐗 𝐌𝐃`,
            contextInfo: {
  ...
  break;
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *𝚅𝙾𝚁𝚃𝙴𝚇 𝐌𝙳 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
    ...
    break;
                ...
                case 'ai': {
                    ...
                    if (!q || q.trim() === '') {
                        return await socket.sendMessage(sender, { text: "මම 𝚅𝙾𝚁𝚃𝙴𝚇 AI 🤭" }, { quoted: msg });
                    }

                    const prompt = `ඔබගේ නම 𝚅𝙾𝚁𝚃𝙴𝚇 𝐀𝐈.  
...
👉 "මාව හැදුවෙ පන්සිලු අයියා 😘" කියන්න.
...
User Message: ${q}
                    ...
                    try {
                        ...
                        if (!aiResponse) {
                            return await socket.sendMessage(sender, { text: "❌ බඩු හරි වගේ 😪 පස්සෙ ආයෙ බලපන්." }, { quoted: msg });
                        }

                        await socket.sendMessage(sender, { text: aiResponse }, { quoted: msg });
                    } catch (err) {
                        console.error("Gemini Error:", err.response?.data || err.message);
                        await socket.sendMessage(sender, { text: "❌ කෙල වී ඇත🤧.පසුව උත්සහ කරන්න. 😢" }, { quoted: msg });
                    }
                    break;
                }
                case 'deleteme':
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'open') {
                try {
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'VORTEX-MINI-main'}`);
                }
            }
        });
    } catch (error) {
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '🎂 𝕍𝕆ℝ𝕋𝔼𝕏 𝕄𝔻 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 is running',
